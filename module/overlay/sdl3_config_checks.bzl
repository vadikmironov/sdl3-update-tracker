...
# https://github.com/libsdl-org/SDL/blob/release-%{upstream_version}/CMakeLists.txt#L124
# https://github.com/libsdl-org/SDL/blob/release-%{upstream_version}/cmake/sdlchecks.cmake#L967-L969
_PROBE_COPTS = [
    "-D_GNU_SOURCE=1",
    "-D_REENTRANT",
]
...
def _decl(symbol, headers):
    ...
    # https://github.com/libsdl-org/SDL/blob/release-%{upstream_version}/CMakeLists.txt#L1107-L1119
    return _builds(
...
# https://github.com/libsdl-org/SDL/blob/release-%{upstream_version}/CMakeLists.txt#L1046-L1076
_LIBC_HEADERS = [
    "float.h",
    "iconv.h",
    "inttypes.h",
...
# https://github.com/libsdl-org/SDL/blob/release-%{upstream_version}/CMakeLists.txt#L1078-L1119
_LIBC_SYMBOLS = {
    "math.h": [
        "acos",
        "acosf",
...
# https://github.com/libsdl-org/SDL/blob/release-%{upstream_version}/CMakeLists.txt#L1121-L1158
_FLOAT_CLASS_COPTS = [
    "-Wfloat-conversion",
    "-Werror",
]
...
# https://github.com/libsdl-org/SDL/blob/release-%{upstream_version}/CMakeLists.txt#L1160-L1182
_UNIX_SYMBOLS = [
    ("fdatasync", ["unistd.h"]),
...
SDL3_CONFIG_CHECKS_LIBC = [
    # https://github.com/libsdl-org/SDL/blob/release-%{upstream_version}/CMakeLists.txt#L1043-L1045
    ...
    # https://github.com/libsdl-org/SDL/blob/release-%{upstream_version}/CMakeLists.txt#L1183-L1210
    checks.AC_TRY_LINK(
        code = "#define LIBICONV_PLUG 1\n#include <stddef.h>\n#include <iconv.h>\nint main(void) { return !iconv_open(NULL, NULL); }\n",
        copts = _PROBE_COPTS,
        define = "HAVE_ICONV",
    ),
    # https://github.com/libsdl-org/SDL/blob/release-%{upstream_version}/CMakeLists.txt#L1212-L1213
    ...
    # https://github.com/libsdl-org/SDL/blob/release-%{upstream_version}/CMakeLists.txt#L1025-L1040
    _header("alloca.h"),
]
...
# https://github.com/libsdl-org/SDL/blob/release-%{upstream_version}/CMakeLists.txt#L618-L640
...
# https://github.com/libsdl-org/SDL/blob/release-%{upstream_version}/cmake/sdlchecks.cmake#L967-L969
# https://github.com/libsdl-org/SDL/blob/release-%{upstream_version}/cmake/sdlchecks.cmake#L1020-L1088
_PTHREAD = {
    "copts": ["-pthread"],
    "linkopts": ["-pthread"],
}
...
# https://github.com/libsdl-org/SDL/blob/release-%{upstream_version}/cmake/sdlchecks.cmake#L52-L72
# https://github.com/libsdl-org/SDL/blob/release-%{upstream_version}/CMakeLists.txt#L1375-L1391
_UNIX_CHECKS = [
...
_LINUX_FIXED = [
    ...
    # https://github.com/libsdl-org/SDL/blob/release-%{upstream_version}/cmake/sdlchecks.cmake#L1248-L1307
    ...
    # https://github.com/libsdl-org/SDL/blob/release-%{upstream_version}/cmake/sdlchecks.cmake#L861-L937
...
# https://github.com/libsdl-org/SDL/blob/release-%{upstream_version}/cmake/sdlchecks.cmake#L273-L564
# https://github.com/libsdl-org/SDL/blob/release-%{upstream_version}/src/video/x11/SDL_x11sym.h#L177-L184
_X11_FIXED = [
...
# https://github.com/libsdl-org/SDL/blob/release-%{upstream_version}/cmake/sdlchecks.cmake#L643-L763
_WAYLAND_FIXED = [
